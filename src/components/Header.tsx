...
function NavLink({ to, label }: { to: string; label: string }) {
  return (
    <Link
      to={to}
      className="relative text-[11px] tracking-[0.28em] uppercase font-medium text-foreground/70 hover:text-foreground transition-colors duration-300 py-1 group"
...
export function Header() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-40 bg-background/90 backdrop-blur-xl transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] ${
        revealed
    ...
    >
      ...
      <div className="border-b border-border">
        <div className="container-x flex h-8 items-center justify-between text-[10px] tracking-[0.32em] uppercase text-muted-foreground font-medium">
      ...
      <div className="relative">
        <div className="container-x grid grid-cols-[1fr_auto_1fr] items-center h-24 gap-6">
          {/* Left: utilities */}
          <div className="hidden lg:flex items-center gap-6 text-[11px] tracking-[0.28em] uppercase text-muted-foreground">
            <button
              aria-label="Buscar"
          ...
          <div className="hidden lg:flex items-center justify-end gap-6">
            ...
            <button
              ...
              className="p-2 rounded-full hover:bg-secondary transition-colors duration-300 text-foreground/60 hover:text-foreground"
            >
          ...
          <div className="lg:hidden justify-self-end flex items-center gap-2">
            ...
            <button
              ...
              className="p-2 text-foreground/70 hover:text-teal transition-colors"
              onClick={() => setOpen((s) => !s)}
            >
              {open ? (
